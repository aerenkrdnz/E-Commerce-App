...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'products',
                loadComponent: () => import('./components/products/components/products/products.component')
                    .then(m => m.ProductsComponent)
            },
            {
                path: 'products/add',
                loadComponent: () => import('./components/products/components/product-add/product-add.component')
            ...
            {
                path: 'baskets',
                loadComponent: () => import('./components/baskets/components/baskets/baskets.component')
                    .then(c => c.BasketsComponent)
            },
            {
                path: 'orders',
                loadComponent: () => import('./components/orders/components/orders/orders.component')
